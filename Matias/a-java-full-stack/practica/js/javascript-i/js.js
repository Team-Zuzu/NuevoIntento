...
/*
4. Una función que se llame siguiente, que reciba como parámetro un valor entero, y devuelva el 
siguiente del número ingresado como parámetro
5. Una función que se llame doble, que reciba como parámetro un valor, y devuelva el doble del número 
ingresado como parámetro.
6. Una función que se llame cuadrado, que reciba como parámetro un valor, y devuelva el valor del 
numero ingresado como parámetro elevado al cuadrado.
7. Una función que se denomine imprimirValores que dado un número por parámetro, imprima cual es el 
valor siguiente, el doble y el cuadrado. Usando las funciones definidas en los puntos 5) , 6) y 7) :siguiente, 
el doble y el cuadrado.
8. Una función que se denomine imprimirElDobleDelSiguiente que dadoun número por parámetro, 
imprima cual es el valor siguiente al el doble. Usando las funciones definidas en los puntos 5) , 6) : 
siguiente, el doble .
9. Una función que se denomine imprimirElDobleDelSiguienteAlCuadrado que dado un número por 
parámetro, imprima cual es el valor siguiente al el doble. Usando las funciones definidas en los puntos 5) , 
6) y 7) : siguiente, el doble y el cuadrado
*/
...
// }
// imprimirElDobleDelSiguiente = num => console.log(doble(siguiente(num)))
// imprimirElDobleDelSiguienteAlCuadrado = num => console.log(doble(cuadrado(siguiente(num))))
...
// const nombres = ['Fer', 'Zoe', 'matias', 'Marcela', 'Erika']
// let cadena = ''
...
// const nombres = ['Fer', 'Zoe', 'matias', 'Marcela', 'Erika']
// for (let i = 0; i < nombres.length; i++) {
//     let primeraLetra = nombres[i].substring(0, 1)
//     nombres[i] = nombres[i].replace(primeraLetra, primeraLetra.toUpperCase())
// }
// console.table(nombres.sort());

// Detector de insultos
// var frase = "hola"
// var puteadas = [
//     "puto",
//     "manco",
