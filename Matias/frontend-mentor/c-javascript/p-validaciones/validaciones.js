...
validateUsername('matiasesp404')
validateEmail('unity.matias@protonmail.com')
validatePasswordComplex('Cascada123!')
validatePasswordModerate('Cascada123')
validateCreditCard(5258551378182430)
validateDni(36167369+'F')